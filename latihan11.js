...
// Pertama : kelipatan angka harus konsisten
// Kedua : bila tidak konsisten maka akan berhenti

// Punya deret angka. 
// Jika deret angka konsisten dalam kelipatannya maka akan berlanjut (true), jika salah maka akan berhenti(false). 
...
function tentukanDeretAritmatika(arr) {
  ...
  for(var i = 1; i < arr.length -1; i++) {
    var selisihTmp = arr[i+1]-arr[i];
    if(selisihTmp !== selisih) {
      deret = false;
    }
  }
  return deret;
